...
use App\Docs\Schemas\Search\Collection\StoreSearchCollectionPersonaSchema;
...
class StoreSearchCollectionPersonaOperation extends Operation
{
    ...
    public static function create(string $objectId = null): BaseObject
    {
        ...
        return parent::create($objectId)
            ...
            ->summary('Perform a search for services filtered by persona')
            ...
            ->requestBody(
                RequestBody::create()
                    ->required()
                    ->content(
                        MediaType::json()->schema(StoreSearchCollectionPersonaSchema::create())
                    )
            )
            ->responses(
                Response::ok()->content(
