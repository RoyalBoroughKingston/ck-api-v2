...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'organisation.name' => ['required_without:organisation.id', 'string', 'min:1', 'max:255'],
            'organisation.description' => ['required_without:organisation.id', 'string', 'min:1', 'max:10000'],
            'organisation.url' => ['required_without:organisation.id', 'url', 'max:255'],
            'organisation.email' => [
                'nullable',
            ...
            'service.criteria' => ['sometimes', 'required', 'array'],
            'service.criteria.age_group' => ['sometimes', 'present', 'nullable', 'string', 'min:1', 'max:255'],
            'service.criteria.disability' => ['sometimes', 'present', 'nullable', 'string', 'min:1', 'max:255'],
            'service.criteria.employment' => ['sometimes', 'present', 'nullable', 'string', 'min:1', 'max:255'],
            'service.criteria.gender' => ['sometimes', 'present', 'nullable', 'string', 'min:1', 'max:255'],
            'service.criteria.housing' => ['sometimes', 'present', 'nullable', 'string', 'min:1', 'max:255'],
            'service.criteria.income' => ['sometimes', 'present', 'nullable', 'string', 'min:1', 'max:255'],
            'service.criteria.language' => ['sometimes', 'present', 'nullable', 'string', 'min:1', 'max:255'],
            'service.criteria.other' => ['sometimes', 'present', 'nullable', 'string', 'min:1', 'max:255'],
